...
mp.clear();
vector<vector<int>>left(n,vector<int>(21,0));
vector<vector<int>>right(n,vector<int>(21,0));
left[0][dp[0]]++;
if(dp[0]==k || dp[n-1]==k)
{
    cout<<1<<endl;
