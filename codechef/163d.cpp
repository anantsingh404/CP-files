...
int main() {
    ...
    while (t--) {
       ...
       string s,p;
       cin>>s>>p;
       vector<pair<char,int>>dp1;
       vector<pair<char,int>>dp2;
        int i=0;
        while(i<n)
        {
            int j=i;
        ...
        else if(n==m || n<m)
        {
            ...
            {
                if(dp1[k].second<dp2[k].second || abs(dp1[k].second-dp2[k].second)%2!=0 || dp1[k].first!=dp2[k].first)
                {
                    ans=false;
                }
            }
