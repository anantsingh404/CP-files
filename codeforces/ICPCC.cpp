...
int main() {
    ...
    while (t--) {
        ...
        for(auto itr:mp)
        {
            ...
            if(itr.second<=4 && itr.second>1)
            {   if(itr.second%2)
            {
                --itr.second;
            }
            if(itr.second>0){
                st.push_back({itr.second,itr.first});
            }
            }
        }
        ...
        if(vp.size()>=4)
        {cout<<"YES"<<endl;
         cout<<vp[0]<<" "<<vp[1]<<" "<<vp[0]<<" "<<vp[n-1]<<" "<<vp[n-2]<<" "<<vp[1]<<" "<<vp[n-2]<<" "<<vp[n-1]<<endl;
        }
        else if(maxi>=8)
        {   
            cout<<"YES"<<endl;
            cout<<vp[0]<<" "<<vp[0]<<" "<<vp[0]<<" "<<vp[0]<<" "<<vp[0]<<" "<<vp[0]<<" "<<vp[0]<<" "<<vp[0]<<endl;
        }
        else
        {
             vector<int>ans;
            ...
            if(ans.size()<4)
            {
                ...
                cout<<"YES"<<endl;
                m=ans.size();
         cout<<ans[0]<<" "<<ans[1]<<" "<<ans[0]<<" "<<ans[m-1]<<" "<<ans[m-2]<<" "<<ans[1]<<" "<<ans[m-2]<<" "<<ans[m-1]<<endl;
            }
        }
